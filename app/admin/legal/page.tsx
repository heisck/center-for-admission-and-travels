                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mb-2">
                      Use HTML tags: &lt;p&gt;, &lt;h2&gt;, &lt;ul&gt;, &lt;li&gt;, &lt;a href=&quot;...&quot;&gt;, etc.
                    </p>
                    <textarea
                      value={content}
                      onChange={(e) => setContent(e.target.value)}
                      rows={24}
                      className="w-full px-3 py-2 border border-border rounded-lg font-mono text-sm text-foreground"
                      placeholder="<section><h2>1. Introduction</h2><p>Your content here...</p></section>"
                    />
                  </div>
