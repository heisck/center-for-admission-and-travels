  ...
  return (
    <section className="relative overflow-hidden pt-12 md:pt-22 lg:py-32 md:pb-22">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Mobile: Content with Masonry as background */}
        <div className="hero-mobile-wrapper" style={{ position: 'relative', width: '100%', minHeight: '420px', zIndex: 10 }}>
          <div className="hero-masonry-background" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', zIndex: 5 }}>
          ...
          <div className="hero-content-wrapper" style={{ zIndex: 20 }}>
            <div>
