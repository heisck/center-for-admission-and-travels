    ...
    <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 min-[1920px]:h-20 min-[2560px]:h-24">
          ...
          {/* Mobile Menu Button + compact dropdown (not full-width) */}
          <div className="xl:hidden relative shrink-0">
            ...
            {isOpen ? (
              <div className="absolute right-0 top-full mt-2 z-50 w-64 sm:w-72 max-w-[calc(100vw-1.5rem)] max-h-[calc(100dvh-5rem)] overflow-y-auto overflow-x-hidden rounded-xl border border-border bg-background/95 backdrop-blur-md shadow-xl p-4 space-y-2">
                {NAV_LINKS.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
